...
class _VehicleControlFormState extends State<VehicleControlFormState> {
  ...
  Future<void> _registerCheckInTimestamp(
  ...
  Future<void> _handleCheckIn(Map<String, dynamic> item) async {
    ...
    DateTime bookingLimitTime = bookingTime.subtract(
  ...
  void _openCheckInTab(Map<String, dynamic> item, {String? reason}) {
    ...
    DynamicTabPage.of(
      context,
    )?.openTab(tabTitle, CheckInFormPage(item: item, lateReason: reason));
  }
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              "⚠️ Batas check-in adalah 15 menit sebelum jam booking dimulai. Silakan masukkan alasan keterlambatan:",
            ),
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: "Contoh: Macet, Ban Bocor, dll",
              ),
              maxLines: 3,
            ),
          ],
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              _registerCheckInTimestamp(
                item,
                lateReason: reasonController.text.trim(),
              );
            },
  ...
  Future<void> _fetchPlanningData({bool showGlobalLoading = false}) async {
    ...
    try {
      ...
      for (var item in response) {
        ...
        if (req['status'] == 'kelayakan unit') continue;
        ...
        children: [
          ...
          Expanded(
            child: _isLoading
                ...
                : RefreshIndicator(
                    onRefresh: () =>
                        _fetchPlanningData(showGlobalLoading: false),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: hasCheckedIn
                        ...
                        : () => _handleCheckIn(item),
                    icon: Icon(
                      hasCheckedIn ? Icons.verified_user : Icons.location_on,
                      color: Colors.white,
                    ),
                    label: Text(
                      hasCheckedIn
