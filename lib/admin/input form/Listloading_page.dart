...
// Pastikan loading data diakses dengan benar (Supabase join mengembalikan List)
            ...
            child:  _isLoading
              ...
              : RefreshIndicator(
                  ...
                  child: _filteredPlanningList.isEmpty 
                      ...
                      : ListView.builder(
                          padding: const EdgeInsets.all(12),
                          // GANTI: Gunakan length dari list yang sudah difilter
                          itemCount: _filteredPlanningList.length, 
                          itemBuilder: (context, index) =>
                              // GANTI: Ambil data dari list yang sudah difilter
