...
class _WeighbridgeState extends State<WeighbridgeState> {
  ...
  Future<void> _submitData(Map<String, dynamic> item, String actionType) async {
    try {
      ...
      _showSnackBar(
        "Data berhasil disimpan & dilanjutkan ke Pos Keluar!",
        Colors.green,
      );
  ...
  Future<void> _fetchPlanningData({bool showGlobalLoading = false}) async {
    ...
    try {
      ...
      for (var item in response) {
        ...
        if (req['status'] == 'weighbridge') continue;
  ...
  Widget _buildPlanningCard(
    ...
    final String checkerName = checkerData != null
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text(
            "Tidak ada antrian weighbridge saat ini",
