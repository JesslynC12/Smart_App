          ...
          children: [
            if (_hasAccess('InputDO'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Input DO", const ShippingRequestPage());
                },
              ),
            if (_hasAccess('KelayakanUnit'))
              _menuItem(
                ...
                "Check in & Kelayakan Unit",
                Colors.teal,
                onTap: () {
                  Navigator.pop(context);
                  DynamicTabPage.of(context)?.openTab(
                    "Check in & Kelayakan Unit",
                    VehicleControlFormState(),
                  );
                },
              ),
            if (_hasAccess('Loading'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Loading Form", ListLoadingState());
                },
              ),
            if (_hasAccess('Weighbridge'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Weighbridge", WeighbridgeState(item: {}));
                },
              ),
            ...
            if (_hasAccess('PPICForm'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("PPIC Form", PPICFormPage());
                },
              ),
            if (_hasAccess('OccupancyForm'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Occupancy Form", WarehouseOccupancyForm());
                },
              ),
            if (_hasAccess('PODForm'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("POD Form", PODReturnPage());
                },
              ),
            if (_hasAccess('Complain'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Complain", const ComplainPage());
                },
              ),
          ],
        ),
          ...
          children: [
            if (_hasAccess('ListDO'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("List DO", const ListDOPage());
                },
              ),
            if (_hasAccess('DOdetailsGBJ'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Do Details GBJ", const DetailsDOGbjPage());
                },
              ),
            ...
            if (_hasAccess('planningAntrian'))
              _menuItem(
                ...
                "List Planning Booking Antrian",
                Colors.amber.shade800,
                onTap: () {
                  Navigator.pop(context);
                  DynamicTabPage.of(context)?.openTab(
                    "List Planning Booking Antrian",
                    BookingPlanningListPage(),
                  );
                },
              ),
            if (_hasAccess('slotAntrian'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Slot Antrian", QueueSlotPage());
                },
              ),
            if (_hasAccess('penilaianVendor'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Penilaian Vendor", VendorEvaluationPage());
                },
              ),
            if (_hasAccess('ListPPIC'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("List PPIC", const PPICListPage());
                },
              ),
            if (_hasAccess('DailyOccupancy'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Daily Occupancy", MasterReviewDailyPage());
                },
              ),
            if (_hasAccess('InDashboard'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("In Dashboard", DashboardCombinedPage());
                },
              ),
            if (_hasAccess('ExDashboard'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Ex Dashboard", OutboundDashboardPage());
                },
              ),
            if (_hasAccess('DashboardLogistik'))
              _menuItem(
                context,
                Icons.dashboard,
                "Laporan Aktivitas Logistik",
                Colors.blue,
                onTap: () {
                  Navigator.pop(context);
                  DynamicTabPage.of(
                    context,
                  )?.openTab("Laporan Aktivitas Logistik", LogisticDashboardPage());
                },
              ),
            ...
            if (_hasAccess('ListComplain'))
              _menuItem(
                ...
                onTap: () {
                  ...
                  DynamicTabPage.of(
                    context,
                  )?.openTab("List Complain", const ComplainConfirmPage());
                },
              ),
          ],
        ),
              ...
              if (_hasAccess('Master')) ...[
                _menuItem(
                  ...
                  onTap: () {
                    ...
                    DynamicTabPage.of(
                      context,
                    )?.openTab("Manajemen User", const UserManagementPage());
                  },
                ),
